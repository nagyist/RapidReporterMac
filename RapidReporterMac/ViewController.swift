...
class ViewController: NSViewController {
    ...
    @IBAction func cameraButtonSelector(sender: AnyObject) {
        ...
        let fileName = fileIOModel?.makeScreenshotFileName(screenshotModel!.getNumberOfScreenshotsTaken())
        let path = fileIOModel!.getAbsolutePathOfSessionFolder() + fileName!
        
        if (flags.intersect(NSEventModifierFlags.ShiftKeyMask)).rawValue != 0 {
    ...
    @IBAction func timeSelector(sender: AnyObject) {
        ...
        let itemClicked: NSMenuItem = sender as! NSMenuItem
    ...
    */
    ...
    /** 
        ...
        - parameter index: An integer representing the index of the element in the categories array that the main label should be set to.
    */
    ...
    /** 
        ...
        - parameter textField: The text field to clear.
    */
    ...
    */
    ...
    func finalise(){
        let currentCategory = sessionModel!.getCurrentCategory()
...
extension ViewController: NSTextFieldDelegate {
    ...
    func control(control: NSControl, textView: NSTextView, doCommandBySelector commandSelector: Selector) -> Bool {
        let categories = sessionModel!.getCategories()
